...
//create a function sumNumbers
// function should accept a single array
...
function isPalindrome(str){
  let upStr = str.toUpperCase()
    let newStr = upStr.split(' ').join('').split('')
...
function isWinningTicket(arr){
  ...
  let booleanVar = true
  arr.forEach((ele, idx) => {
    console.log('TIS YOUR DATA', ele[0].includes(String.fromCharCode(ele[1])))
